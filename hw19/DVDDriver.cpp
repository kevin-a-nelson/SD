...
int main(){
    ...
    cout << "Test of increment operators:" << endl;
    d1.display(); cout << endl; // [2.  Shadowlands/RichardAttenborough]
    cout << ++d1 << endl; // 3
    d1.display(); cout << endl; // [3.  Shadowlands/RichardAttenborough]

    cout << d1++ << endl; // 3
    d1.display(); cout << endl; // [4.  Shadowlands/RichardAttenborough]
